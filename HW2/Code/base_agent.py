	...
	def train(self):
		...
		while self.total_time_step <= self.training_steps:
			...
			while True:
				...
				self.replay_buffer.append(observation, [action], [reward], next_observation, [terminate])
				...
				if terminate or truncate:
					self.writer.add_scalar('Train/Episode Reward', np.mean(episode_reward), self.total_time_step)
					self.writer.add_scalar('Train/Episode Len', np.mean(episode_len), self.total_time_step)
